...
1. Check the box next to **_"Initialize this repository with a README"_**.
1. In the **_Add .gitignore_** menu, make no selection. We will manually add a .gitignore in a later step.
1. In the **_Add a license_** menu, you have multiple options. Feel free to read about them and make a choice; for general open-source use, we recommend the MIT license.
1. Click the green **_Create repository_** button.
1. On the next screen, click the green **_Clone or download_** button on the right side of the screen. Copy the HTTPS link to clone the repository.
